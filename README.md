<div align="center">
  <img src="https://playwright.dev/img/playwright-logo.svg" alt="Playwright Logo" width="80" height="80"/>
    <h1>Playwright CRX Pro</h1>h1>
  <p>
        <a href="https://playwright.dev">
                <img src="https://img.shields.io/badge/Powered%20by-Playwright-2EAD33?style=flat&logo=playwright&logoColor=white" alt="Playwright"/>
        </a>a>
    ...
    <p><strong>A Chrome Extension that records browser interactions and automatically generates Playwright Python POM test scripts — no manual scripting required.</strong>strong></p>p>
</div>div>
          ...
          - - **State detection** — Mark steps as state detectors to generate `is_visible` / state-check helpers
            - - **One-click export** — Copy to clipboard or download the generated `.py` file instantly
              ...
              - <div align="center">
                ...
                | Technology | Purpose |
                |---|---|
                | <img src="https://playwright.dev/img/playwright-logo.svg" width="20"/> [Playwright](https://playwright.dev) | Test automation framework (code target) |
                | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white) | Generated script language |
                | ![Chrome Extension](https://img.shields.io/badge/Chrome%20Extension-Manifest%20v3-4285F4?style=flat&logo=google-chrome&logoColor=white) | Extension platform |
                ...
                >       3. 3. Enable **Developer mode** (toggle in the top-right corner)
                >          4. 4. Click **Load unpacked** and select the cloned repository folder
                >             5. 5. The **Playwright CRX Pro** extension will appear in your toolbar
                >               
                >                6. ---
                >               
                >                7. ## How to Use
                >               
                >                8. 1. Click the extension icon or open the **Side Panel** in Chrome
                > 2. Press **Record** to start capturing browser interactions
                > 3. 3. Interact with any website — clicks, form fills, navigation, etc.
                >    4. 4. Use **Pick element** to inspect and select a specific element
                >       5. 5. Use **Detect state** to mark a step as a state/visibility checker
                >          6. 6. Choose your preferred **Selector strategy** (text, role, css, xpath, etc.)
                >             7. 7. Set the **Class name** for the generated POM class
                >                8. 8. Press **Copy** to copy the generated Python code or **Save** to download it as a `.py` file
                >                  
                >                   9. ---
                >                  
                ...
                > ## Requirements
                >
                > - **Google Chrome** (version 114 or later, for Manifest v3 + Side Panel support)
                > - **Python 3.8+** with [Playwright](https://playwright.dev/python/docs/intro) installed for running generated scripts:
                >   ```bash
                ...
                >
                > <div align="center">
                  Made with ❤️ using <a href="https://playwright.dev"><img src="https://playwright.dev/img/playwright-logo.svg" width="16" height="16" style="vertical-align:middle"/> Playwright</a>
                  </div>
              </p>
  </p></h1>
